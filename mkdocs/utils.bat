...
:Download
    ...
    if /i "%verbosity%" neq "quiet" (
        call :WriteLine "Downloading !fileToGet! from !storageUrl! to !downloadToDir!\!dirToSave!" "!color_info!"
    )
...
:SetupPython
    ...
    set installPath=!absoluteRootDir!\bin\!platform!\!pythonName!
    ...
    if exist "!installPath!" (
        ...
        if not exist "!installPath!" (
            call :Download "%assetStorageUrl%"runtimes/ "!baseDir!" "!pythonName!.zip" "!pythonName!" "Downloading Python !pythonVersion! interpreter..."
            if exist "!downloadPath!\!platform!\!pythonName!" (
...
:InstallPythonPackages
    ...
    set virtualEnv=!absoluteRootDir!\bin\!platform!\!pythonName!\venv
